...
export const fleet: FleetCar[] = [
  { id: "atlas-q5", name: "Atlas Q5", modelYear: "2024", type: "SUV", image: "/manus-storage/velocity-suv_f11b8d82.jpg", rate: 78, fuel: "Hybrid", transmission: "Automatic", seats: 7, available: true, unavailableWindows: [{ start: "2026-08-25", end: "2026-08-27" }, { start: "2026-09-05", end: "2026-09-08" }], accent: "A versatile city-to-coast companion.", note: "Quiet confidence, generous cabin space." },
