...
export default function Home() {
  ...
  const handleQuickSearch = (criteria: QuickSearchCriteria) => { setRentalCriteria(criteria); setSelectedCategory(criteria.carType); window.requestAnimationFrame(scrollToFleet); };
