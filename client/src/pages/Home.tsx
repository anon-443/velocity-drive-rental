...
export default function Home() {
  ...
  return <div id="home" className="velocity-interior min-h-screen overflow-x-hidden bg-[#f7f8f6] text-[#0f1e2e]"><Navbar /><main>
    ...
    </div><motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.16, duration: 0.35, ease: [0.23, 1, 0.32, 1] }} className="interior-search relative z-20 translate-y-7 lg:translate-y-9"><HeroSearch onSearch={handleQuickSearch} /></motion.div></div></section>
