...
export default function Home() {
  ...
  const scrollToFleet = () => { const target = document.querySelector<HTMLElement>("#fleet"); if (!target) return; const headerHeight = document.querySelector<HTMLElement>(".interior-nav")?.offsetHeight ?? 76; const top = Math.max(0, target.getBoundingClientRect().top + window.scrollY - headerHeight - 40); window.scrollTo({ top, behavior: "smooth" }); };
